...
local function checkForConflict(binding1, binding2)
    --It's only a conflict if there is 1 or more action sets in common
...
return {
    ...
    -- Internal interface to pass inputs to the settings renderer during the main menu
    -- I would just use the RecordVRBinding event but you can't send events from menu scripts to menu scripts...
    interfaceName = '_vrinputssettingsrenderer',
    interface = {
        version = 0,
